...
<div class="container">
  <div class="product-images">
    <div class="main-image">
      <img src="{{ asset('images/neklesh-img.png') }}" alt="{{ $product->name }}">
    </div>
    <div class="image-gallery">
      <img src="{{ asset('images/neklesh-img.png') }}" alt="Product Image 1">
      <img src="{{ asset('images/neklesh-img.png') }}" alt="Product Image 2">
      <img src="{{ asset('images/neklesh-img.png') }}" alt="Product Image 3">
    </div>
  </div>
